...
$currentYear = date("Y");
$sql_old = "SELECT COUNT(*) as row_count FROM patients WHERE YEAR(date) != '$currentYear' AND fclt_id = '$fclt_id'";
$sql_new = "SELECT COUNT(*) as row_count FROM patients WHERE YEAR(date) = '$currentYear' AND fclt_id = '$fclt_id'";
