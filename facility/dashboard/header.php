  ...
  <div class="toast-container position-fixed bottom-0 end-0 p-3"></div>
        ...
        <img class="facility-logo" src="../../assets/<?php echo $_SESSION["fcltimg"] ?>" alt="facility logo">
          ...
          <li>
             ...
             <i class="fi fi-sr-apps"></i><span class="sidebar-label">Dashboard</span>
            </a>
            </li>
            ...
            if (isset($_SESSION["facilityaccount"])) {
              if ($_SESSION["fclttype"] == 'Birthing Home') {
               ?>
                <li>
                    <a href="referrals.php" class="sidebarbtn <?php echo (basename($_SERVER['PHP_SELF']) === 'referrals.php' ? 'active' : '') ?>" id="referrals-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Referrals">
                        <i class="fi fi-sr-document"></i><span class="sidebar-label">Your Referrals</span>
                    </a>
                </li>
                <li>
                    <a href="for-referral-patients.php" class="sidebarbtn <?php echo basename($_SERVER['PHP_SELF']) === 'for-referral-patients.php' ? 'active' : ''; ?>" id="messages-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="For REferral Patients">
                    <i class="fi fi-sr-users-alt"></i><span class="sidebar-label">For Referral Patients</span>
                    </a>
                </li>
                <li>
                    <a href="messages.php" class="sidebarbtn <?php echo basename($_SERVER['PHP_SELF']) === 'messages.php' ? 'active' : ''; ?>" id="messages-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Messages">
              ...
              <?php 
            }else if ($_SESSION["fclttype"] == 'Hospital' || $_SESSION["fclttype"] == 'Provincial Hospital') {
              ?>
                <li>
                ...
                <li>
                    <a href="accepted_referrals.php" class="sidebarbtn <?php echo (basename($_SERVER['PHP_SELF']) === 'accepted_referrals.php' ? 'active' : ''); ?>" id="accepted-referrals-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Referral Transactions">
                ...
                <li>
                    <a href="prenatal_list.php" class="sidebarbtn <?php echo basename($_SERVER['PHP_SELF']) === 'prenatal_list.php' ? 'active' : ''; ?>" id="prenatal-list-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Prenatal List">
            ...
            ?>
               <li>
                  <a href="calendar.php" class="sidebarbtn <?php echo basename($_SERVER['PHP_SELF']) === 'calendar.php' ? 'active' : ''; ?>" id="calendar-list-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Calendar">
                    <i class="fi fi-sr-calendar-clock"></i><span class="sidebar-label">Calendar</span>
                  </a>
                </li>
              <div class="footer">
              <li>
