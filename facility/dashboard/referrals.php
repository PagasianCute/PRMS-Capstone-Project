  ...
  <?php 
    if (isset($_SESSION["facilityaccount"])) {
        if ($_SESSION["fclttype"] == 'Birthing Home' || $_SESSION["fclttype"] == 'Provincial Hospital') {
            ...
            <button type="button" class="right-button btn btn-primary referralCreateBtn" id="report"><i class="fi fi-br-plus"></i> Create Referral</button>
            </div>';
        }
    }
    ?>
 ...
 <div class="table-responsive">
  <table id="referralsTable" class="table">
    ...
    <tbody id="referral-tbody">
      ...
      foreach ($displayreferrals as $key => $displayreferral) {
        $count++;
        $rffrl_id = $displayreferral['rfrrl_id'];
        $rfrrd_hospital = $displayreferral['fclt_name'];
        ...
        if ($status == 'Sent To a Doctor') {
          ...
          $status_id = $displayreferral['status'];
        }

        ?>
        <tr>
          <td><?php echo $rffrl_id ?></td>
          <td><?php echo $rfrrd_hospital ?></td>
          <td><?php echo $Name ?></td>
          <td class="action-column" id="<?php echo $status_id ?>-column"><p><?php echo $status ?></p></td>
        ...
        <div class="tab-content" id="myTabContent1">
          <div class="tab-pane fade show active" id="referralRecord" role="tabpanel" aria-labelledby="referralRecord-tab">
            ...
            <div class="row">
              ...
              <input type="text" name="emergency_type" id="view_emergency_type" class="form-control" readonly>
              </div>
