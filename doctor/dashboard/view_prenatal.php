...
<script src="js/ajaxViewPrenatal.js"></script>
    <div class="head">
        ...
        <a class="btn btn-primary" target='_blank' href="server/generateRecords.php?id=<?php echo $_GET['id'] ?>&record=<?php echo $_GET['record'] ?>" role="button"><i class="fi fi-sr-print"></i> Print</a>
