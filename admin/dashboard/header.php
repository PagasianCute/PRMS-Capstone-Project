  ...
  <body>
			<nav id="sidebar" class="active">
              <img class="facility-logo" src="../../assets/<?php echo $_SESSION["fcltimg"] ?>" alt="facility logo">
                ...
                <li>
                    <a href="admin-referrals.php" class="sidebarbtn <?php echo (basename($_SERVER['PHP_SELF']) === 'admin-referrals.php' ? 'active' : '') ?>" id="referrals-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Referrals">
                        <i class="fi fi-sr-document"></i><span class="sidebar-label">Referrals</span>
                    </a>
                </li>
                <li>
                    <a href="reports.php" class="sidebarbtn <?php echo (basename($_SERVER['PHP_SELF']) === 'reports.php' || basename($_SERVER['PHP_SELF']) === 'add_prenatal.php' || basename($_SERVER['PHP_SELF']) === 'view_prenatal.php') ? 'active' : ''; ?>" id="prenatal-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Prenatal">
                    <i class="fi fi-rr-chart-histogram"></i><span class="sidebar-label">Reports</span>
                    </a>
                </li>
                <?php if($_SESSION["fclttype"] == 'Birthing Home'){ ?>
                <li>
                    <a href="admin-prenatal.php" class="sidebarbtn <?php echo (basename($_SERVER['PHP_SELF']) === 'admin-prenatal.php' || basename($_SERVER['PHP_SELF']) === 'add_prenatal.php' || basename($_SERVER['PHP_SELF']) === 'view_prenatal.php') ? 'active' : ''; ?>" id="prenatal-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Prenatal">
                ...
                <li>
                    <a href="admin-accounts.php" class="sidebarbtn <?php echo basename($_SERVER['PHP_SELF']) === 'admin-accounts.php' ? 'active' : ''; ?>" id="accounts-link" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Staff Management">
                    <i class="fi fi-sr-user-pen"></i><span class="sidebar-label">Staff Management</span>
                    </a>
                </li>
                <?php
                  }
